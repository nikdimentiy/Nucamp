...
if __name__ == "__main__":
    ...
    while True:
        ...
        if choice == 1:
            player_choice = {'X': cur_player, 'O': player2 if cur_player == player1 else player1}
        elif choice == 2:
            player_choice = {'O': cur_player, 'X': player2 if cur_player == player1 else player1}
        elif choice == 3:
            print("Final Scores")
            print_scoreboard(score_board)
            break
        ...
        winner = single_game(player_choice['X'])
